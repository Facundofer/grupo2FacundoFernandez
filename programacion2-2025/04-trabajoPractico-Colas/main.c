...
int main(){
    ...
    bool boleano;
    int entrada = 0;
    int ejercicio, resultado, claveBuscar, posicionordinal, elementoagregar, tiempodecola, tamano_cola1, tamano_cola2, tamano_cola3;
    while (entrada != -1)
    {
        ...
        case 3:
            ...
            printf("La complejidad algoritmica es de o(n) ya que recorro toda la cola con n elementos una vez\n");
            vaciarcola(cola1);
            vaciarcola(cola2);
            break;
        ...
        case 4:
            ...
            c_mostrar(solucion);
            printf("La complejidad algoritmica es de o(n al cuadrado) ya que recorro toda la cola por cada elemento de la misma n*n\n");
            vaciarcola(cola1);
            vaciarcola(solucion);
            break;
        ...
        case 5:
            ...
            printf("La complejidad algoritmica es de o(n al cuadrado) ya que recorro toda la cola por cada divisor y el peor caso todos pueden ser divisores\n");
            vaciarcola(cola1);
            break;
        ...
        case 6:
            ...
            printf("La complejidad algoritmica es de o(n * m) ya que recorro toda la cola n por cada elemento de cola2 n*m\n");
            vaciarcola(cola1);
            vaciarpila(pila);
            break;  
        case 7:
            ...
            c_cargar(cola3);
            tamano_cola1 =  c_ej2_contarelementos(cola1);
            tamano_cola2 = c_ej2_contarelementos(cola2);
            tamano_cola3 = c_ej2_contarelementos(cola3);
            while ((tamano_cola1 + tamano_cola2 + tamano_cola3) > 100)
            {
                vaciarcola(cola1);
                vaciarcola(cola2);
                vaciarcola(cola3);
                printf("No se puede la suma total del tamano es mayor a la pila resultado\n");
                printf("cargando cola1\n");
                c_cargar(cola1);
                printf("cargando cola2\n");
                c_cargar(cola2);
            ...
            printf("Ingresando el tiempo de atencion.\n");
            ...
            printf("La complejidad algoritmica es de o(n) ya que recorro toda la cola con n elementos una vez m siendo la cola mas grande\n");
            vaciarcola(cola1);
            vaciarcola(cola2);
            vaciarcola(cola3);
            vaciarcola(solucion);
